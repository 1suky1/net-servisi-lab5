...
namespace lab5.JWTApi.Controllers
{
    ...
    public class AddressesController : Controller
    {
        ...
        {
            return _context.Address.Include(m => m.StateProvince).Take(20);
        }
		...
		public async Task<IActionResult> GetAddress([FromRoute] int id)
        {
            ...
            var address = await _context.Address.Include(m => m.StateProvince).SingleOrDefaultAsync(m => m.AddressId == id);
